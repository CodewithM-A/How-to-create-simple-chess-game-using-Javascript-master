...
class Chess {
	...
	async assignPlayers() {
		...
		return new Promise((resolve) => {
			const player1 = new Player({ username: "M A", id: 1, role: "white" }); // player 1
			const player2 = new Player({ username: "R", id: 2, role: "black" }); // player 2
	...
	getPossibilities() {
		...
		const Pattern = {
			...
			Queen: function () {
				...
				Pattern.Bishope(); // can move like a bishope
			},
